...
public class DebugFive1
{
   public static void main(String args[])
   {
      ...
      "\n3 - Grilled cheese\n4 - Fish sandwich");
      usersChoiceString = input.nextLine(); //nextLine
      usersChoice = Integer.parseInt(usersChoiceString); //remove one equal
      if(usersChoice == 1 || usersChoice == 2)
         bill = bill + HIGH_PRICE;
      else
         bill = bill + MED_PRICE;
      System.out.println("Fries with that?\n1 - Yes\n2 - No"); //closing )
      usersChoiceString = input.nextLine(); //next line && closing semi
